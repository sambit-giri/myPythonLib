...
def mfp2d(arr, xth=0.5, boxsize=100, iterations=1000000, verbose=True):
	info    = arr.shape	
	...
	size_mt = size_px * boxsize/info[0]
	size_dP = siz*size_mt
	return (size_dP, size_mt)


def mfp3d(arr, xth=0.5, boxsize=100, iterations=10000000, verbose=True):
